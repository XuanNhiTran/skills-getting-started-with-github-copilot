...
activities = {
    ...
    "Track Team": {
        "description": "Track and field training and seasonal meets",
    ...
    "Photography Club": {
        "description": "Learn photography techniques and participate in photo walks and shows",
    ...
    "Debate Team": {
        "description": "Practice formal debate, public speaking, and attend tournaments",
